...
In this study, we report on the sequencing and assembly of the mitochondrial genome of Sitka spruce (Picea sitchensis, Pinaceae), a largely distributed conifer in the coastal regions of the Pacific Northwest. We show that this mitochondrial genome is one of the largest among plants, with intricate branching and multipartite physical genome structures.
